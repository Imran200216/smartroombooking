...
class FourthYearSmartRoomBookingScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    /// providers
    final fourthYearSmartRoomBookingProvider =
        Provider.of<FourthYearSmartRoomBookingProvider>(context);
                            ...
                            return Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  CustomIconBtn(
                                    isLoading:
                                        fourthYearSmartRoomBookingProvider
                                            .isLoading,
                                    onTap: () {
                                      showDialog(
                                        context: context,
                                            ...
                                            onConfirm: () {
                                              ...
                                              if (notificationTime.isBefore(
                                                ...
                                                NotificationService.showInstantNotification(
                                                  "Smart Room Booking",
                                                  "Reminder: Your booking for Smart Room 401 is at $earliestSlot today!",
                                                );
                                              } else {
                                                NotificationService.scheduledNotification(
                                                  "Smart Room Booking",
                                                  "Reminder: Your booking for Smart Room 401 is at $earliestSlot.",
                                                  notificationTime,
                                                );
                                              }
                                              ...
                                              NotificationService.showInstantNotification(
                                                currentUserName,
                                                "Smart Room 401 is booked successfully in $bookingDate",
                                              );
                                            },
                                          );
                                        },
                                          ...
                                          return CustomAlertDialogBox(
                                            ...
                                            onConfirm: () {
                                              ...
                                              if (notificationTime.isBefore(
                                                ...
                                                NotificationService.showInstantNotification(
                                                  "Smart Room Booking",
                                                  "Reminder: Your booking for Smart Room 402 is at $earliestSlot today!",
                                                );
                                              } else {
                                                NotificationService.scheduledNotification(
                                                  "Smart Room Booking",
                                                  "Reminder: Your booking for Smart Room 402 is at $earliestSlot.",
                                                  notificationTime,
                                                );
                                              }
                                              ...
                                              NotificationService.showInstantNotification(
                                                currentUserName,
                                                "Smart Room 402 is booked successfully in $bookingDate",
                                              );
                                            },
                                          );
                                        },

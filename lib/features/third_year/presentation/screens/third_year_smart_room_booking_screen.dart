...
class ThirdYearSmartRoomBookingScreen extends StatelessWidget {
  const ThirdYearSmartRoomBookingScreen({super.key});

  @override
  Widget build(BuildContext context) {
    /// providers
    final thirdYearSmartRoomBookingProvider =
        Provider.of<ThirdYearSmartRoomBookingProvider>(context);
                            ...
                            return Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  CustomIconBtn(
                                    isLoading:
                                        thirdYearSmartRoomBookingProvider
                                            .isLoading,
                                    onTap: () {
                                      showDialog(
                                        context: context,
                                            ...
                                            onConfirm: () {
                                              ...
                                              if (notificationTime.isBefore(
                                                ...
                                                NotificationService.showInstantNotification(
                                                  "Smart Room Booking",
                                                  "Reminder: Your booking for Smart Room 301 is at $earliestSlot today!",
                                                );
                                              } else {
                                                NotificationService.scheduledNotification(
                                                  "Smart Room Booking",
                                                  "Reminder: Your booking for Smart Room 301 is at $earliestSlot.",
                                                  notificationTime,
                                                );
                                              }
                                              ...
                                              NotificationService.showInstantNotification(
                                                currentUserName,
                                                "Smart Room 301 is booked successfully in $bookingDate",
                                              );
                                            },
                                          );
                                        },
                                          ...
                                          return CustomAlertDialogBox(
                                            ...
                                            onConfirm: () {
                                              ...
                                              if (notificationTime.isBefore(
                                                ...
                                                NotificationService.showInstantNotification(
                                                  "Smart Room Booking",
                                                  "Reminder: Your booking for Smart Room 302 is at $earliestSlot today!",
                                                );
                                              } else {
                                                NotificationService.scheduledNotification(
                                                  "Smart Room Booking",
                                                  "Reminder: Your booking for Smart Room 302 is at $earliestSlot.",
                                                  notificationTime,
                                                );
                                              }
                                              ...
                                              NotificationService.showInstantNotification(
                                                currentUserName,
                                                "Smart Room 302 is booked successfully in $bookingDate",
                                              );
                                            },
                                          );
                                        },
